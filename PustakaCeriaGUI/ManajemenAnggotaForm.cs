...
{
    public partial class ManajemenAnggotaForm : Form
    {
        ...
        public ManajemenAnggotaForm()
        {
            InitializeComponent();
            this.Load += new EventHandler(ManajemenAnggotaForm_Load);
        }

        private void ManajemenAnggotaForm_Load(object sender, EventArgs e)
        {
